...
ReturnValue Help(const char* Name)
{
    ...
    cout <<
        ...
        "\n"
        "       --help-edit\n"
        "              Displays the help guide for edit options.\n"
        "\n"
        "       --version\n"
        ...
        "\n"
        "       --io-threads value\n"
        "              Force the number of IO threads to value.\n"
        "              Default value is found in the system hardware concurrency, if\n"
        "              available, otherwise it will default to 4.\n"
        "\n"
        "       --quiet\n"
        ...
        "\n"
        "       --edit \"key=value\"\n"
        "              Edit audio-visual RAW data.\n"
        "              Valid keys are listed by using --help-edit option.\n"
        "              All other features are deactivated when using this option.\n"
        "\n"
        ...
        "\n"
        "COPYRIGHT\n"
        "       Copyright (c) 2018-2026 MediaArea.net SARL & Reto Kromer\n"
        "\n"
        "LICENSE\n"
