...
ReturnValue Help(const char* Name)
{
    ...
    cout << endl;
    cout << "       --full-check" << endl;
    cout << "              Do costly (in terms of analysis duration or bytes read) checks." << endl;
    cout << "              This guaranties reversability." << endl;
    cout << "              Default value is partial check." << endl;
    cout << endl;
    ...
    cout << "              Avoid costly (in terms of analysis duration or bytes read) checks." << endl;
    cout << "              This may lead to partial reversibility with non conform files." << endl;
    cout << "              Default value is partial check." << endl;
    cout << endl;
